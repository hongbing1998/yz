(function ($) {
    $.uiWidget('ui.Pagination', {
        ...
        _createPagination: function () {
            var $el = this.element, options = this.options, self = this,
                perPageRecord = (!options.perPageRecord || options.perPageRecord < 0) ? 1 : options.perPageRecord,
                totalRecord = (options.totalRecord < 0) ? 0 : options.totalRecord,
                currentPage = options.currentPage - 1, st = options.showType;
