...
<body>
<form class="form-inline definewidth m20" action="/school/condition_query" method="post">
    学校名称： <input type="text" name="schoolName" id="param" class="abc input-default" placeholder="输入要查询的学校名称"
                 value="${schoolName}">&nbsp;&nbsp;
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <c:forEach items="${page.records}" var="school" varStatus="status">
        <tr>
            <td>${status.count}</td>
            ...
            <td>
                ...
                <a class="option-button" href="/school/delete/${school.id}" onclick="return confirm('是否确认删除？')">删除</a>
